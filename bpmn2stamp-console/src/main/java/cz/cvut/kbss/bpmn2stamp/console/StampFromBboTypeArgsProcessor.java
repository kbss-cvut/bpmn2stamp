...
import static cz.cvut.kbss.bpmn2stamp.console.CommandLineUtils.optSynopsisString;
...
public class StampFromBboTypeArgsProcessor implements ArgsProcessor<StampFromBboTypeArgsProcessor.ParsingResult> {
	...
	public String getSynopsis() {
		return "\tbpmn2stamp -t stampFromBbo " + CommandLineUtils.optSynopsisString(inputBaseIriOpt) +
				" " + CommandLineUtils.optSynopsisString(inputBboFileNameOpt) +
