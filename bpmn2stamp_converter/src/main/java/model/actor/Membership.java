...
public class Membership {
    ...
    protected List<model.actor.element.Membership> membership;
     ...
     * 
     */
    public List<model.actor.element.Membership> getMembership() {
        if (membership == null) {
            membership = new ArrayList<model.actor.element.Membership>();
        }
