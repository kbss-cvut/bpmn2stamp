...
//        props.put(JOPAPersistenceProperties.ONTOLOGY_PHYSICAL_URI_KEY, setupRepository(ontologyFile));
        ...
        props.put(OwlapiOntoDriverProperties.MAPPING_FILE_LOCATION, "srcasdad/main/resources/jopa/mapping/mapping.map");
...
//        props.put(JOPAPersistenceProperties.LANG, "en");
        ...
        props.put(JOPAPersistenceProperties.SCAN_PACKAGE, "org.example.model.bbo.model");
