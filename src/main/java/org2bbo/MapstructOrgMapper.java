...
@Mapper
public abstract class MapstructOrgMapper extends OntologyMapstructMapper {

    @Mapping(source = "rootElement", target = "result")
    public Org2BboMappingResult definitions(TDefinitions definitions) {
...
//    public abstract Process participantToProcess(TParticipant participant);
    ...
    Org2BboMappingResult rootElementMapping(List<JAXBElement<? extends TRootElement>> rootElement) {
