        ...
        implements Serializable
{
     ...
     *
     */
    @OWLObjectProperty(cascade = CascadeType.ALL, iri = Vocabulary.s_p_has_timeCycle)
...
//        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Expression, max = 1)
     ...
     *
     */
    @OWLObjectProperty(cascade = CascadeType.ALL, iri = Vocabulary.s_p_has_timeDate)
    @ParticipationConstraints({
//        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Expression, max = 1)
    })
     ...
     *
     */
    @OWLObjectProperty(cascade = CascadeType.ALL, iri = Vocabulary.s_p_has_timeDuration)
    @ParticipationConstraints({
//        @ParticipationConstraint(owlObjectIRI = Vocabulary.s_c_Expression, max = 1)
    })
